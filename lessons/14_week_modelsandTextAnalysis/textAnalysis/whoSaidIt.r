...
pathname <-  "/home/o/obonhamcarter/Desktop/data/tm"
...
#On the left side are the predictions from the model: there were 13 docs that were predicted to have been Obama speeches. On top (going down columns) are the actual counts of documents which were spoken by Obama. All 13 were actually spoken by Obama. There were six predicted Trump speeches (reading left to right) of which six were actually spoken by Trump (looking down the right column.)
